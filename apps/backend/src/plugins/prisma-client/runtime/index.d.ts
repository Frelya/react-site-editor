...
declare type Args = Optional<RequiredArgs>;
...
declare type ClientBuiltInProp = '$connect' | '$disconnect' | '$transaction' | '$extends';
...
/** Client */
declare type DynamicClientExtensionArgs<C_, TypeMap extends TypeMapDef, TypeMapCb extends TypeMapCbDef, ExtArgs extends Record<string, any>> = {
...
declare type DynamicClientExtensionThis<TypeMap extends TypeMapDef, TypeMapCb extends TypeMapCbDef, ExtArgs extends Record<string, any>> = {
    [P in keyof ExtArgs['client']]: Return<ExtArgs['client'][P]>;
} & {
    [P in Exclude<TypeMap['meta']['modelProps'], keyof ExtArgs['client']>]: DynamicModelExtensionThis<TypeMap, ModelKey<TypeMap, P>, ExtArgs>;
} & {
    [P in Exclude<keyof TypeMap['other'], keyof ExtArgs['client']>]: <A extends TypeMap['other'][P]['args']>(...args: A extends any[] ? A : [A]) => PrismaPromise_2<GetResult_2<TypeMap['other'][P]['payload'], A, P & Operation>>;
} & {
...
/** Model */
declare type DynamicModelExtensionArgs<M_, TypeMap extends TypeMapDef, ExtArgs extends Record<string, any>> = {
...
declare type DynamicModelExtensionThis<TypeMap extends TypeMapDef, M extends PropertyKey, ExtArgs extends Record<string, any>> = {
    [P in keyof ExtArgs['model'][Uncapitalize<M & string>]]: Return<ExtArgs['model'][Uncapitalize<M & string>][P]>;
} & {
    [P in Exclude<keyof TypeMap['model'][M], keyof ExtArgs['model'][Uncapitalize<M & string>]>]: {} extends TypeMap['model'][M][P]['args'] ? <A extends TypeMap['model'][M][P]['args']>(args?: A) => PrismaPromise_2<GetResult_2<TypeMap['model'][M][P]['payload'], A, P & Operation>> : <A extends TypeMap['model'][M][P]['args']>(args: A) => PrismaPromise_2<GetResult_2<TypeMap['model'][M][P]['payload'], A, P & Operation>>;
} & {
    [K: symbol]: {
...
/** Query */
declare type DynamicQueryExtensionArgs<Q_, TypeMap extends TypeMapDef> = {
    [K in keyof Q_]: K extends '$allOperations' ? (args: {
        ...
        [P in keyof Q_[K] | keyof TypeMap['model'][keyof TypeMap['model']] | '$allOperations']?: P extends '$allOperations' ? DynamicQueryExtensionCb<TypeMap, 'model', keyof TypeMap['model'], keyof TypeMap['model'][keyof TypeMap['model']]> : P extends keyof TypeMap['model'][keyof TypeMap['model']] ? DynamicQueryExtensionCb<TypeMap, 'model', keyof TypeMap['model'], P> : never;
    } : K extends TypeMap['meta']['modelProps'] ? {
        [P in keyof Q_[K] | keyof TypeMap['model'][ModelKey<TypeMap, K>] | '$allOperations']?: P extends '$allOperations' ? DynamicQueryExtensionCb<TypeMap, 'model', ModelKey<TypeMap, K>, keyof TypeMap['model'][ModelKey<TypeMap, K>]> : P extends keyof TypeMap['model'][ModelKey<TypeMap, K>] ? DynamicQueryExtensionCb<TypeMap, 'model', ModelKey<TypeMap, K>, P> : never;
    } : K extends keyof TypeMap['other'] ? DynamicQueryExtensionCb<[TypeMap], 0, 'other', K> : never;
};
...
declare type DynamicQueryExtensionCbArgs<TypeMap extends TypeMapDef, _0 extends PropertyKey, _1 extends PropertyKey, _2 extends PropertyKey> = (_1 extends unknown ? _2 extends unknown ? {
    ...
    query: (args: DynamicQueryExtensionCbArgsArgs<TypeMap, _0, _1, _2>) => PrismaPromise_2<TypeMap[_0][_1][_2]['result']>;
};

declare type DynamicQueryExtensionCbArgsArgs<TypeMap extends TypeMapDef, _0 extends PropertyKey, _1 extends PropertyKey, _2 extends PropertyKey> = _2 extends '$queryRaw' | '$executeRaw' ? Sql : TypeMap[_0][_1][_2]['args'];

/** Result */
declare type DynamicResultExtensionArgs<R_, TypeMap extends TypeMapDef> = {
    [K in keyof R_]: {
        [P in keyof R_[K]]?: {
...
declare type DynamicResultExtensionData<TypeMap extends TypeMapDef, M extends PropertyKey, S> = GetFindResult<TypeMap['model'][M]['findFirstOrThrow']['payload'], {
    select: S;
}>;
...
declare interface ExtendsHook<Variant extends 'extends' | 'define', TypeMapCb extends TypeMapCbDef, ExtArgs extends Record<string, any>, TypeMap extends TypeMapDef = Call<TypeMapCb, {
    ...
    extArgs: ExtArgs;
    <Q_ extends {
        [K in TypeMap['meta']['modelProps'] | '$allModels' | keyof TypeMap['other'] | '$allOperations']?: unknown;
    }, R_ extends {
...
declare type GetResult<Base extends Record<any, any>, R extends Args_3['result'][string], KR extends keyof R = string extends keyof R ? never : keyof R> = {
...
declare type GetSelect<Base extends Record<any, any>, R extends Args_3['result'][string], KR extends keyof R = string extends keyof R ? never : keyof R> = {
...
declare type PrismaPromiseCallback = (transaction?: PrismaPromiseTransaction) => PrismaPromise<unknown>;
 ...
 * @returns
 */
declare type PrismaPromiseFactory = (callback: PrismaPromiseCallback) => PrismaPromise<unknown>;
...
declare class RequestHandler {
    ...
    mapQueryEngineResult({ protocolMessage, dataPath, unpacker, modelName, args, extensions }: RequestParams, response: QueryEngineResult<any>): any;
    /**
...
declare function validator<C, M extends Exclude<keyof C, `$${string}`>, O extends keyof C[M] & Operation>(client: C, model: M, operation: O): <S>(select: Exact<S, Args_4<C[M], O>>) => S;

declare function validator<C, M extends Exclude<keyof C, `$${string}`>, O extends keyof C[M] & Operation, P extends keyof Args_4<C[M], O>>(client: C, model: M, operation: O, prop: P): <S>(select: Exact<S, Args_4<C[M], O>[P]>) => S;
