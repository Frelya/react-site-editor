...
const styleClasses = {
    ...
    itemsList:
        'w-11/12 mx-auto h-fit py-5 items-start gap-1 list-none transition-all duration-1000',
    itemsListVisible: 'grid grid-cols-auto-fit',
    itemsListInvisible: 'hidden',
    item: 'cursor-pointer w-fit h-fit'
};
